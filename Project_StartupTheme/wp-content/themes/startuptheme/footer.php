                    ...
                    <div class="row gx-5">
                            <?php
                                if(is_active_sidebar('footer-address-sidebar')){
                                    echo dynamic_sidebar('footer-address-sidebar');
                                }
                            ?>
            ...
            <div class="row justify-content-end">
                <div class="col-lg-8 col-md-6">
                    <div class="d-flex align-items-center justify-content-center" style="height: 75px;">
                        <p class="mb-0">&copy; <a class="text-white border-bottom" href="#">Your Site Name</a>. All Rights Reserved. |  Develop by Pobitro Deb
                    </div>
                </div>
            </div>
        </div>
