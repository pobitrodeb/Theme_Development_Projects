                                    ...
                                    <div class="content-box overlay-item">
                                        ...
                                        <div class="blog-content-one blog-content-two sp-six centred">
                                            <div class="top-content">
                                                <div class="meta-text"><a href="#"><?php echo the_category(); ?></a></div>
                                                <div class="title"><h4><a href="<?php the_permalink();?>"><?php echo the_title(); ?></a></h4></div>
                                                <div class="date"><span>On</span>  <?php echo get_the_date();?> &nbsp;&nbsp;<i class="flaticon-circle"></i>&nbsp;&nbsp;<span>By</span> <?php the_author(); ?></div>
                                            </div>
                                            <div class="text">
                                            <?php the_excerpt(); ?>
                                            </div>
