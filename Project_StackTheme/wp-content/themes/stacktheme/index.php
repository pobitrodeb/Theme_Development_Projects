        ...
        <div class="row">
          <div class="col-lg-6 col-md-12 col-sm-12">
            <div class="text-wrapper">
              <div>
                <h2 class="title-hl wow fadeInLeft" data-wow-delay="0.3s"><?php echo get_theme_mod('about_heading_text'); ?></h2>
                <p class="mb-4 stack_theme_about_content">
                    <?php echo get_theme_mod('about_section_content') ;?>
                </p>
                <a href="#" class="btn btn-common stacktheme_about_btn"><?php echo get_theme_mod('about_button_text'); ?></a>
              </div>
            </div>
          </div>
...
<!-- 
    ...
    <section id="services" class="section-padding bg-gray">
      <div class="container">
        <div class="section-header text-center">
          <h2 class="section-title wow fadeInDown services_title" data-wow-delay="0.3s"><?php echo get_theme_mod('services_title'); ?></h2>
          <p class ="services_subtitle"><?php echo get_theme_mod('services_subtitle'); ?></p>
        </div>
        <div class="row">
          <!-- Services item -->
           <?php
            if(get_theme_mod('services_checkbox', true)){
              $settings = get_theme_mod('services_repeater'); 
                ...
                foreach($settings as $item){
                 ...
                 <div class="<?php echo get_theme_mod('services_column') ?>">
                    <div class="services-item wow fadeInRight" data-wow-delay="0.3s">
                      <div class="icon">
                        <i class="services_icon <?php echo $item['service_icon']?>"></i>
                      </div>
                      <div class="services-content">
                        <h3><a href="#"> <?php echo $item['services_title']?> </a></h3>
                        <p><?php echo $item['services_desc']?></p>
                      </div>
                    </div>
                  </div>
                  <?php
    ...
    <?php
      if(get_theme_mod('show_video_section', true)){
        ?>
              ...
              <div class="row">
                <div class="col-md-12 col-sm-12">
                  <div class="video-promo-content text-center wow fadeInUp" data-wow-delay="0.3s">
                    ...
                    <h2 class="mt-3 video_title wow zoomIn" data-wow-duration="1000ms" data-wow-delay="100ms">
                      <?php echo get_theme_mod('video_section_title'); ?>
                    </h2>
                  </div>
                </div>
              </div>
    ...
    ?>
      ...
      <?php 
            if(get_theme_mod('team_section_checkbox', true)){
              ?>
              <!-- Team Section Start -->
              <section id="team" class="section-padding text-center">
                <div class="container">
                  <div class="section-header text-center">
                    <h2 class="section-title team_title wow fadeInDown" data-wow-delay="0.3s"><?php echo get_theme_mod('team_section_title'); ?></h2>
                    <p class="team_subtitle">
                    <?php echo get_theme_mod('team_subtitle'); ?>
                    </p>
                  </div>
                  <div class="row">
                    
                    <?php
                      if ($teams = get_theme_mod('team_member_repeater')) {
                              ...
                              ?> 
                                  <div class="col-sm-6 col-md-6 col-lg-3">
                                    ...
                                    <div class="team-item text-center wow fadeInRight" data-wow-delay="0.3s">
                                      ...
                                      <div class="info-text">
                                        <h3><a href="#"><?php echo $team['team_name']; ?></a></h3>
                                        <?php
                                          if($team['team_degination']){
                                            ?>
                                              <p><?php echo $team['team_degination']; ?></p>
                                            <?php
                                          }
                                        ?>
